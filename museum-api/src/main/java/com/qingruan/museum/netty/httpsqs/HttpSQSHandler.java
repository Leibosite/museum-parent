...
import com.qingruan.museum.api.MuseumApi;
...
import com.qingruan.museum.api.service.rest.RestfulService;
...
public class HttpSQSHandler extends ChannelInboundHandlerAdapter {
	...
	static {		
		ApplicationContext context = MuseumApi.applicationContextGuardian.GetAppContext();
