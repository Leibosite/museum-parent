package com.qingruan.museum.engine.framework;
...
//			ExceptionLog.logException(e, log);
	...
	public RuleCore getRuleCore() {
		if (this.ruleCore == null)
			this.ruleCore = (RuleCore) ApplicationContextGuardian.getInstance()
					.GetAppContext().getBean("ruleCore");
		return ruleCore;
	}
