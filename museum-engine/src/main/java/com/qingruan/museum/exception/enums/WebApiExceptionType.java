...
public enum WebApiExceptionType {
	MISS_WEATHER_DEVICE_ID(2002), MISS_WEATHER_HISTORY_PARAMS(2003), RECORDS_NOT_EXIST_IN_DB(
			...
			2021), MISS_MONITOR_STATION_Name(2022), MISS_CONSTANT_TH_NAME(2023), MISS_SHOW_CASE_NAME(
			2024), MISS_EAMIL_TEMPLATE_NAME(2025), ID_ERROR(2026), TOKEN_ERROR(
			2027), OPERATOR_ERROR(2028), PARAMETERS_ERROR(2029);
