...
<head>
<title><fmt:message key="pageTitle.data_visualization_statistics" /></title> 
                   ...
                   <table id="tech-companies-1" class="table table-small-font table-bordered">
                      <thead>
                         <tr>
                            ...
                            <th data-priority="1"><fmt:message key="th.areaName" /></th>
                            <th data-priority="3"><fmt:message key="th.monitoring_point" /></th>
                            <th data-priority="1"><fmt:message key="th.data_type" /></th>
                            <th data-priority="3"><fmt:message key="th.value" /></th> 
                         </tr>
                      </thead>
                      <tbody>
                         ...
                         <tr id="changeColor"> 
                            ...
                            <td><c:out value="${dataRecord.device.repoArea.name}" /></td>
                            <td><c:out value="${dataRecord.device.name}" /></td>
                            <td><c:out value="${dataRecord.objectType.value}" /></td> 
                            <td><c:out value="${dataRecord.value}" /></td>  
                         </tr>   
                         </c:forEach>
                      </tbody>
                   </table>
