	...
	<div id="js-ajax-repalce-block" style="position: relative">
		...
		<h2 style="position: relative">
			...
			<span class="oper-block-title btn-group"> <a
				...
				href="${ctx}/evaluation/customize/addAtomicCustomizedStandard?groupId=${id}&page=${page}&id=">
				...
				<c:forEach items="${pageObjects.content}" var="atomicStandard">
					<tr>
						...
						<td width="165px"><a class="badge badge-info"
							href="${ctx}/evaluation/customize/addAtomicCustomizedStandard?groupId=${id}&id=${atomicStandard.id}&page=${page}"><fmt:message
									key="btn.edit" /></a> <a class="badge badge-important delete-item"
							href="${ctx}/evaluation/customize/deleteAtomicCustomizedStandard?groupId=${id}&id=${atomicStandard.id}&page=${page}"><fmt:message
									key="btn.delete" /></a> 
							<!--
