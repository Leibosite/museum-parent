		...
		<div class="topSelect" class="widget-content nopadding">
			...
			<table id="deviceEdit">
				<tr>
					<td>未绑定设备:</td>
					<td>
						<form:select path="deviceId" id="device-id">
							<form:options items="${unbundleDevices}" itemValue="id" itemLabel="name"/>
						</form:select>
					</td>
				</tr>
				<tr>
			...
			<a onclick="getpoint($('#device-id').val(),$('#repoAreaId').val())" class="btn btn-primary btn-small" href="#">取点</a>
		</div>
		</div>
	</div>