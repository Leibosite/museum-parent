...
<script type="text/javascript">
	...
	<div class="modal-body" style="width: 60%; height: 400px; margin: auto;">
		<div class="topSelect" class="widget-content nopadding">
				...
				<tr>
					...
					<td>
						<form:select path="repoAreaId" id="repoAreaId">
							<form:options items="${unBundleAreas}" itemValue="id" itemLabel="name"/>
						</form:select>
					</td>
				</tr>
				<tr>
			...
			<button class="btn btn-primary" style="float: left;" onclick="drawLocation($('#repoAreaId').val())">绘制区域位置</button>
		</div>
		</div>
	</div>